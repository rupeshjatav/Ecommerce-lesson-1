...
const provider = new firebase.auth.GoogleAuthProvider(); //to provide access to google authentication
provider.setCustomParameters({ 'prompt': 'select_account' }); //custom parameters --- to pop up select account window
